...
from sensor.component.modal_evaluation import ModelEvaluation ,ModelResolver
...
if __name__=="__main__":
     try:
          ...
          data_ingestion_config  = config_entity.DataIngestionConfig(traning_pipeline_config=training_pipeline_config)
